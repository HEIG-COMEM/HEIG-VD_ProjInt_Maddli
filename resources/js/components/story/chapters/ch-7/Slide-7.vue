...
<template>
    <section data-auto-animate :data-background-image="bg" class="relative h-full">
        <Character
            ...
            :poseNumber="5"
            :chNumber="7"
            class="!-top-[40%] !left-[30%] md:!-top-[30%] md:!left-[30%] xl:!left-[45%] xl:!top-[30%]"
        />
        <Character
            type="parent"
            :scale="0.2"
        ...
        />
        <DialogBubble
            class="!left-[45%] !top-[5%] max-w-[15rem] md:!left-[41%] md:!max-w-xs xl:!left-[53%] xl:!top-[15%] 2xl:!left-[52%] 2xl:!top-[30%] 2xl:!max-w-md"

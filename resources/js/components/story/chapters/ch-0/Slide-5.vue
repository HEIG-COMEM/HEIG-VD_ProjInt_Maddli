...
<template>
    <section data-auto-animate data-background-color="#006565" class="relative h-full py-16">
        <div class="flex h-full flex-col justify-between">
            ...
            <DialogBubble
                ...
                tailPosition="left"
                class="!left-[45%] !top-[10%] !max-w-[16rem] md:!left-[50%] md:!top-[5%] md:!max-w-sm lg:!max-w-md xl:!left-[50%] xl:!top-[10%] xl:!max-w-lg"
            />
            <Character
                type="coach"
                :scale="0.2"
                :poseNumber="5"
                :chNumber="0"
                class="!-top-[30%] !left-[35%] md:!-top-[25%] md:!left-[40%] xl:!left-[45%] xl:!top-[20%] 2xl:!left-[45%]"
            />
        </div>
    </section>
</template>

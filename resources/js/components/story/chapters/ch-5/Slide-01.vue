...
const audio = new Audio('/assets/story/ch-5/sfx/s1.mp3');

const slideIndex = 36; // TODO : Update dynamically
...
<template>
    <section :data-background-image="bg" data-auto-animate class="h-full">
        ...
        <img
            src="/assets/story/ch-5/elements/scoreboard.svg"
            alt="Scoreboard"
        ...
        <div class="absolute bottom-[10%] right-[5%] flex flex-col items-end">
            <Caption class="!static">
                <p class="text-left">The game has ended. Your team won 2-1.</p>
            </Caption>
        </div>
    </section>
</template>

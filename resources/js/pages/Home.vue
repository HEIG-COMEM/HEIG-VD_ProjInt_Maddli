...
<template>
    ...
    <WebLayout>
        <div class="relative h-screen w-screen bg-accent p-16">
            <div class="absolute inset-0 top-16 z-10 flex h-full w-full flex-col items-center justify-center px-8 text-white">
                <div class="mb-24 w-full">
                    <h1 class="text-4xl font-bold sm:text-6xl md:text-8xl lg:text-9xl">Become a coach</h1>
                    <p class="mt-4 text-lg sm:text-xl md:text-2xl lg:text-3xl">Welcome to the Hello Coach Simulation!</p>
                </div>
                <div class="flex w-full flex-col justify-between gap-12 sm:flex-row">
                    <div class="flex w-1/2 flex-col items-start justify-center gap-4">
                        ...
                        <P class="rounded-md bg-white/10 p-8">
                    ...
                    <div class="h-full w-1/2 rounded-md bg-accent p-8">
                        <div class="flex flex-row items-center gap-4">
                            <PlayCircle class="h-12 w-12" />
                            <div>
                                <H2>Hello Coach vidéo</H2>
                                <P class="!mt-0">Discover the Hello Coach</P>
                            </div>
                        </div>
                        <div class="relative mt-4 h-auto w-full">
                            ...
                            <div v-if="!isPlaying" class="absolute inset-0" @click="playVideo()">
                                <div class="flex h-full w-full items-center justify-center rounded-md bg-black/30">
                                    <Play class="h-16 w-16 cursor-pointer text-white" />
                                </div>
                            </div>
                        </div>
                    </div>
